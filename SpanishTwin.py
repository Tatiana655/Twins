...
class TwinSpanish(object):
    ...
    def __add__(self, other):
        ...
        return TwinSpanish(galka(galka(self.X_in.a + other.X_in, self.X_in.b + other.X_in),
    ...
    def __neg__(self):
        return TwinSpanish(-self.X_in, -self.X_ex)
    ...
    def __invert__(self):
        ...
        return TwinSpanish(1 / self.X_in, 1 / self.X_ex)
